...
export _WORDS="$cdir/database/respostas/aleatorio/$var"
...
do
	...
	echo -e "\033[99;1m\n\n░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░$_TITULO░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░\n\n\033[m";
	cat $cdir/database/perguntas/aleatorio/$var
	echo
	...
	if [ $(echo $_PALAVRA | egrep "$_X" ) ]; then
 	...
 	# caso não exista a letra na palavra, entra nesse bloco
	 	...
	 	# game over
 			...
 			tput cup 0 0;
 			export _RESET="\033[40;37;1mPara reiniciar pressione: [Ctrl + A]\033[m"
 			export _EXIT="░░░░░░░░░░░░░░░░░░░░░░░░░░░░░"
